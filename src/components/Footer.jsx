  ...
  return (
    <footer className="max-padd-container mb-4">
      <div className="max-padd-container bg-primary rounded-tr-3xl pt-12 xl:pt-20 pb-8">
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus deleniti eaque eligendi necessitatibus ea perferendis.</p>
        ...
        <div className=" flex justify-between flex-wrap gap-x-2 gap-y-8">
          <div className="max-w-sm">
            ...
            <p className="py-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic velit aliquid necessitatibus ad amet fugit.</p>
        ...
        <div className="flex justify-between flex-wrap gap-8 pt-16">
          {
